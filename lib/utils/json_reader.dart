...
class JsonReader {
  ...
  final DateTime _defaultDateTime;

  factory JsonReader(dynamic json) => JsonReader._(json, permissive: true);
  ...
  JsonReader._(
    ...
    Color defaultColor = ProjectColors.primaryColor,
  ...
  Color asColor({
    ...
    Color? defaultValue,
      ...
      _getColor(
        json,
        permissive: permissive ?? _permissive,
        defaultValue: defaultValue ?? _defaultColor,
      );
...
Color _getColor(
  dynamic value, {
  bool permissive = true,
  Color defaultValue = ProjectColors.primaryColor,
}) {
  final dynamic v = value;
  if (permissive && v == null) {
    return defaultValue;
  }
  if (v is int) {
    return Color(v);
  ...
  throw ArgumentError('Illegal value: $v');
}
